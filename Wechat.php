...
namespace componentsforyii2\weixin;
use EasyWeChat\Payment\LuckyMoney\API;
use EasyWeChat\Payment\Order;
use yii\base\Component;
use componentsforyii2\weixin\models\Redpack;
use componentsforyii2\weixin\models\Transfers;

/**
 * 微信组件
 * Class Weichat
 * @package componentsforyii2\weixin
 */
